          ...
          <div className="w-full max-w-md text-center">
            <div className="mb-4 rounded-md bg-destructive/10 p-4">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                This login is for students only. Please use the appropriate login for your role.
              </p>
            </div>
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Sign in to your NRB Vidyalaya student account
          </p>
        </div>
        ...
        <div className="rounded-lg border bg-card p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-center justify-end">
              <Link
                to={ROUTES.STUDENT_FORGOT_PASSWORD}
